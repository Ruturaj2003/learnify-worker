...
const difficulty = "medium"; // Change to "easy", "medium" or "hard" to test other levels

async function testQuiz() {
  console.log(`\n🔍 Requesting a ${difficulty} level Quiz from Gemini...`);
  const quiz = await generateQuiz(dummyChapter, difficulty);
